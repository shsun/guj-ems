...
public class MASTAdConstants {
	...
	public static final int DEFAULT_AD_SERVER_TIMEOUT = 3000; // server side
																// timeout, in
																// milliseconds;
																// 1000 before

	public static final int DEFAULT_LOCATION_REPEAT_WAIT = 5 * 60 * 1000; // 5
																			// minutes
																			// (in
																			// millis)
	public static final float DEFAULT_LOCATION_REPEAT_DISTANCE = 1000.0F; // 1000
																			// meters
	...
	public static final int AD_TYPE_THIRDPARTY = 8; // special case, treated as
													// rich media
	//
	public static final int AD_TYPE_EXTERNAL_THIRDPARTY = 16; // not for
																// request, used
																// after
																// processing
																// response
	...
	public static final String STR_EMPTY_SERVER_RESPONSE = "No ads available"; // MUST
																				// exactly
																				// match
																				// error
																				// returned
