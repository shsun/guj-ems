...
public class AdImageView extends WebView {
	...
	public AdImageView(AdViewContainer parent, MASTAdLog log,
			DisplayMetrics metrics, boolean handleClicks) {
	...
	public void setImage(AdData ad) {
		...
		data.append("var scaleFactor = " + SdkUtil.getDensity() + ";"); // normWidth;
																		// if
																		// (normWidth
																		// >
																		// normHeight)
		...
		data.append("<div id=\"adwrap\"><A HREF=\"" + ad.clickUrl
				+ "\"><IMG ID=\"ADIMAGE\" SRC=\"" + ad.imageUrl
				+ "\"></A></div>");
		data.append("</body></html>");

		// System.out.println("AdImageView: injecting code: " +
		// data.toString());
