...
final public class FileUtils {
	...
	public static String md5(String data) {
		try {
			...
			logger.log(MASTAdLog.LOG_LEVEL_ERROR, "FileUtils.md5 - exception",
					e.getMessage());
		}
	...
	public static String readTextFromJar(Context context, String source) {
		...
		try {
			...
			logger.log(MASTAdLog.LOG_LEVEL_ERROR,
					"FileUtils.readTextFromJar - exception", e.getMessage());
		}
	...
	public static String copyTextFromJarIntoAssetDir(Context context,
		...
		try {
			...
			MASTAdLog logger = new MASTAdLog(null);
			logger.log(MASTAdLog.LOG_LEVEL_ERROR,
					"FileUtils.copyTextFromJar - exception", e.getMessage());
		}
