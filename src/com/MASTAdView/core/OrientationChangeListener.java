...
final public class OrientationChangeListener extends OrientationEventListener {
	 ...
	 * degrees when its right side is to the top. ORIENTATION_UNKNOWN is
	 * returned when the device is close to flat and the orientation cannot be
	 * determined.
	 */
	public void onOrientationChanged(int orientation) {
		// Get device rotation value as well, so we can do the right thing for
		// tablets and other
		// devices that are naturally "landscape" instead of "portrait" like a
		// phone.
