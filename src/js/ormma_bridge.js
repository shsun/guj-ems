  ...
  */
  ...
  ormmaview.playVideo = function( URL, properties ) {
   ...
   ormmaview.createEvent = function( date, title, body ) {
		...
		try {		
		ORMMAUtilityControllerBridge.createEvent(msecs.toString(), title.toString(), body.toString());
		} catch ( e ) {
   ...
   ormmaview.storePicture = function( URL ) {
	   try {
		   ORMMAUtilityControllerBridge.storePicture( URL )
	   }
	   catch ( e ) {
   ...
   ormmaview.addAsset = function( URL, alias ) {
	   try {
		   ORMMAUtilityControllerBridge.addAsset( URL, alias )
	   }
	   catch ( e ) {
   ...
   ormmaview.removeAsset = function( alias ) {
	   try {
		   ORMMAUtilityControllerBridge.removeAsset( alias )
	   }
	   catch ( e ) {
