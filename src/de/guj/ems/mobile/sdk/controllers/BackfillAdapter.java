...
/**
 * Every adapter to an additional SDK which is used
 * for backfilling must implement this interface.
 * 
 * An adapter is chose be the BackfillDelegator class
 * depending on the main adserver's response.
 * 
...
public interface BackfillAdapter {
	...
	/**
	 * The execute method of the adapter is called by the BackfillDelegator class
	 * depending on the main adserver's response.
